...
(function () {
    ...
    const scriptSrc = document.currentScript ? document.currentScript.src : '/RVA/rossie/rossie.js';
    ...
    if (!document.querySelector('link[href="/RVA/rossie/rossie.png"]')) {
        const preloadLink = document.createElement('link');
        preloadLink.rel = 'preload';
        preloadLink.as = 'image';
        preloadLink.href = '/RVA/rossie/rossie.png';
    ...
    const defaultHistory = `
        <div class="rossie-message-row bot">
            <img src="/RVA/rossie/rossie.png" class="rossie-msg-avatar" alt="Rossie" loading="eager" decoding="async" width="28" height="28" draggable="false">
    ...
    container.innerHTML = `
        <div id="rossie-chatbot-window">
            <div class="rossie-header">
                <div class="rossie-header-info">
                    <div class="rossie-avatar"><img src="/RVA/rossie/rossie.png" alt="Rossie" loading="eager" fetchpriority="high" decoding="async" width="40" height="40" draggable="false"></div>
                    <div>
        ...
        <button id="rossie-chatbot-toggle" aria-label="Open Chat">
            <img src="/RVA/rossie/rossie.png" alt="Rossie AI" loading="eager" fetchpriority="high" decoding="async" width="60" height="60" draggable="false">
        </button>
    `;
    ...
    function appendMessage(text, sender) {
        ...
        if (sender === 'bot') {
            rowDiv.innerHTML = `
                <img src="/RVA/rossie/rossie.png" class="rossie-msg-avatar" alt="Rossie" loading="lazy" decoding="async" width="28" height="28" draggable="false">
    ...
    function handleToolCall(data) {
        if (data.tool_call === 'create_quote') {
            ...
            confirmBtn.addEventListener('click', () => {
                ...
                fetch('http://localhost/RVA/school_management/admin/quotes', {
                    method: 'POST',
                    headers: {
    ...
    function showTyping() {
        ...
        rowDiv.innerHTML = `
            <img src="/RVA/rossie/rossie.png" class="rossie-msg-avatar" alt="Rossie" loading="lazy" decoding="async" width="28" height="28">
