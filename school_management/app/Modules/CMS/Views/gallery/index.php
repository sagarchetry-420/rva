                    ...
                    <tr>
                        <td>
                            <?php if (!empty($g['image_path'])): ?>
                                <img src="/<?php echo htmlspecialchars($g['image_path']); ?>" alt="Photo" style="width: 80px; height: 60px; object-fit: cover; border-radius: 4px; cursor: pointer;" class="clickable-photo" data-image="<?php echo htmlspecialchars($g['image_path']); ?>" data-title="<?php echo htmlspecialchars($g['title']); ?>" data-category="<?php echo htmlspecialchars($g['category'] ?? 'General'); ?>" onclick="openPhotoPreview_gal(this)">
                            <?php else: ?>
