<?php
/**
 * Blank Layout — Minimal wrapper for standalone pages (public results, receipts, etc.)
 * No sidebar, no navigation — just the raw page content with base styles.
 */
$pageTitle = $pageTitle ?? 'Rose Valley Academy';
?>
<!DOCTYPE html>
<html lang="en">
<head>
